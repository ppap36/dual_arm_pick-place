...
#include <ros/ros.h>
#include "test_gazebos_att.h"
#include "test_gazebos_att/Attach.h"
#include "test_gazebos_att/AttachRequest.h"
#include "test_gazebos_att/AttachResponse.h"
...
namespace gazebo
{
  ...
  bool GazeboRosLinkAttacher::attach_callback(test_gazebos_att::Attach::Request &req,
                                              test_gazebos_att::Attach::Response &res)
  {
  ...
  bool GazeboRosLinkAttacher::detach_callback(test_gazebos_att::Attach::Request &req,
                                              test_gazebos_att::Attach::Response &res){
